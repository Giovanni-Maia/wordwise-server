...
public class WordwiseTestCase {
	...
	public void testListWord() {
		...
		List<Word> list = wordResource.list(new ListWordParameters(2));
	...
	public void testAddTranslationWithNewWord() {
		...
		assertEquals(translationSaved.getTranslation(),
				translation.getTranslation());
		assertEquals(translationSaved.getWord().getWord(), translation
				.getWord().getWord());
		assertEquals(translationSaved.getLanguage().getLanguage(), translation
				.getLanguage().getLanguage());
		assertEquals(translationSaved.getLanguage().getCode(), translation
				.getLanguage().getCode());
	}
	...
	public void testAddTranslationWithExistentWord() {
		...
		list = translationResource.list(new ListTranslationParameters(de, null,
				5, null));
